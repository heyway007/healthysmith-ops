        ...
        <div className={`mt-6 max-w-lg ${formCardClassName}`}>
          ...
          <form action={recordPayment.bind(null, payingBill.id)} className="mt-4 space-y-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href="/admin/purchase/payables" className={secondaryButtonClassName}>
                ยกเลิก
              </Link>
            </div>
          </form>
              ...
              return (
                <tr key={b.id} className="border-t border-teal-100 hover:bg-teal-50">
                  ...
                  <td className="px-4 py-3 text-right">
                    <Link
                      href={`/admin/purchase/payables?bill=${b.id}`}
                      className="rounded-lg border border-teal-200 px-3 py-1.5 text-sm font-medium text-teal-700 hover:border-orange-300 hover:text-orange-600"
                    >
                      บันทึกจ่าย
                    </Link>
                  </td>
